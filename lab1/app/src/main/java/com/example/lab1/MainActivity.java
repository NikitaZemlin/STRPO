...
public class MainActivity extends AppCompatActivity {
    ...
    public void countSumTrunc(double sum){
        String proc = String.valueOf(procent.countSumTrunc(sum, pr));
